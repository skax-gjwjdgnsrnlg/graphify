...
**Plans**: 5 plans (BE wave 1→3 → FE wave 4→5)
- [ ] 06.9-01-PLAN.md — BE Foundation: V37 paper_runs migration + PaperRun entity/repo + PaperTrade.run_id + start/stop run lifecycle (wave 1)
- [ ] 06.9-02-PLAN.md — BE Tagging+Services: PaperExecutor run_id stamping + PaperRunListService + PaperRunContributionService (wave 2)
- [ ] 06.9-03-PLAN.md — BE REST: GET /runs + /runs/:id/dashboard|history|report (2-mode) + DTOs (wave 3)
- [ ] 06.9-04-PLAN.md — FE IA+Nav: nav 3그룹 + 토스 PAPER 숨김 + 모니터링 제거 + 전략운영 위젯 + run API/types (wave 4)
- [ ] 06.9-05-PLAN.md — FE Pages: PaperRunsListPage + PaperRunDetailPage (3탭 + 2-mode 기간필터) (wave 5)
...
| 6.9. 모의 운영 IA 재구조화 & 실행 이력 | 0/5 | Planned | 5 plans, 5 waves |
