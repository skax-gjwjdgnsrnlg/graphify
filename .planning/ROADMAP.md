...
- [ ] **Phase 5: 토스증권 OAuth & 자격증명 관리** - 토스증권 client_id/secret 암호화 저장, 토큰 자동 발급·갱신, 실계좌 잔고 조회를 구현한다
...
| 4. 대시보드·룰 생애주기·모니터·리포트 UI | 0/4 | Planned    |  |
| 5. 토스증권 OAuth & 자격증명 관리 | 0/2 | Not started | - |
